...
/datum/mapGeneratorModule/bottomLayer/grassTurfs2
	spawnableTurfs = list(/turf/simulated/floor/grass = 100) //100% chance of grass in every tile.
...
/datum/mapGeneratorModule/bottomLayer/sand_floor
	spawnableTurfs = list(/turf/simulated/floor/plating/beach/sand = 100) //100% chance of beach sand in every tile.

/datum/mapGeneratorModule/desert_lizards
	spawnableAtoms = list(/mob/living/simple_animal/lizard = 2)
